...
xcopy ..\build\service\Release\KVNForceService.exe ..\build\Release\service\ /E /I /H /Y
C:\Qt\6.11.0\msvc2022_64\bin\windeployqt6.exe ..\build\Release\service\KVNForceService.exe
...
xcopy ..\build\app\Release\KVNForce.* ..\build\Release\app\ /E /I /H /Y
C:\Qt\6.11.0\msvc2022_64\bin\windeployqt6.exe --qmldir ..\app\src\gui_forms\  ..\build\Release\app\KVNForce.exe
xcopy C:\Users\ksp\vcpkg\installed\x64-windows\bin\cpptrace.dll ..\build\Release\app\ /Y